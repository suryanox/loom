...
export function Toolbox({
  ...
  const [sectionsOpen, setSectionsOpen] =
    useState<Record<SectionKey, boolean>>(initialSections);
    ...
    <div className="toolbox">
      ...
      {isSearching ? (
        <div className="toolbox-section">
          <div className="toolbox-section-header toolbox-section-header--static">
            ...
            <span className="toolbox-section-badge">
        ...
        <>
            ...
            return (
              <div key={group} className="toolbox-section">
                ...
                >
                  ...
                  <span
                    className={`toolbox-section-chevron ${sectionsOpen[group] ? "open" : ""}`}
                  >
                    ›
                  </span>
                </button>
          ...
          <div className="toolbox-section">
            ...
            >
              ...
              <span
                className={`toolbox-section-chevron ${sectionsOpen.notes ? "open" : ""}`}
              >
                ›
              </span>
            </button>
      ...
      <div className="toolbox-section">
        ...
        >
          ...
          <span
            className={`toolbox-section-chevron ${sectionsOpen.lines ? "open" : ""}`}
          >
            ›
          </span>
        </button>
      ...
      <div className="toolbox-section">
        ...
        >
          ...
          <span
            className={`toolbox-section-chevron ${sectionsOpen.arrows ? "open" : ""}`}
          >
            ›
          </span>
        </button>
