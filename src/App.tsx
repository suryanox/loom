    ...
    >
      ...
      <button
        ...
        style={{
          ...
          gap: 6,
          padding: "6px 12px",
          background: confirmClear ? "#dc2626" : darkMode ? "rgba(20,20,20,0.6)" : "rgba(255,255,255,0.92)",
          ...
          boxShadow: confirmClear ? "0 2px 8px rgba(220,38,38,0.4)" : darkMode ? "none" : "0 1px 4px rgba(0,0,0,0.08)",
        }}
      >
        {confirmClear ? (
          <>
          ...
          <>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <path d="M9 6V4a1 1 0 011-1h1a1 1 0 011 1v2" />
            </svg>
            Clear
          </>
        )}
...
export default function App() {
  ...
  return (
    <ReactFlowProvider>
      <div className={`app-container ${darkMode ? "dark" : ""}`} style={{ position: "relative" }}>
        <Toolbox
